...
- (NSString *)tt_hmacStringUsingAlg:(CCHmacAlgorithm)alg withKey:(NSString *)key {
    size_t size;
    switch (alg) {
...
- (NSData *)tt_hmacDataUsingAlg:(CCHmacAlgorithm)alg withKey:(NSData *)key {
    size_t size;
    switch (alg) {
        case kCCHmacAlgMD5: size = CC_MD5_DIGEST_LENGTH; break;
        case kCCHmacAlgSHA1: size = CC_SHA1_DIGEST_LENGTH; break;
...
- (NSString *)tt_hmacMD5StringWithKey:(NSString *)key {
    return [self tt_hmacStringUsingAlg:kCCHmacAlgMD5 withKey:key];
}

- (NSData *)tt_hmacMD5DataWithKey:(NSData *)key {
    return [self tt_hmacDataUsingAlg:kCCHmacAlgMD5 withKey:key];
}

- (NSString *)tt_hmacSHA1StringWithKey:(NSString *)key {
    return [self tt_hmacStringUsingAlg:kCCHmacAlgSHA1 withKey:key];
}

- (NSData *)tt_hmacSHA1DataWithKey:(NSData *)key {
    return [self tt_hmacDataUsingAlg:kCCHmacAlgSHA1 withKey:key];
}

- (NSString *)tt_hmacSHA224StringWithKey:(NSString *)key {
    return [self tt_hmacStringUsingAlg:kCCHmacAlgSHA224 withKey:key];
}

- (NSData *)tt_hmacSHA224DataWithKey:(NSData *)key {
    return [self tt_hmacDataUsingAlg:kCCHmacAlgSHA224 withKey:key];
}

- (NSString *)tt_hmacSHA256StringWithKey:(NSString *)key {
    return [self tt_hmacStringUsingAlg:kCCHmacAlgSHA256 withKey:key];
}

- (NSData *)tt_hmacSHA256DataWithKey:(NSData *)key {
    return [self tt_hmacDataUsingAlg:kCCHmacAlgSHA256 withKey:key];
}

- (NSString *)tt_hmacSHA384StringWithKey:(NSString *)key {
    return [self tt_hmacStringUsingAlg:kCCHmacAlgSHA384 withKey:key];
}

- (NSData *)tt_hmacSHA384DataWithKey:(NSData *)key {
    return [self tt_hmacDataUsingAlg:kCCHmacAlgSHA384 withKey:key];
}

- (NSString *)tt_hmacSHA512StringWithKey:(NSString *)key {
    return [self tt_hmacStringUsingAlg:kCCHmacAlgSHA512 withKey:key];
}

- (NSData *)tt_hmacSHA512DataWithKey:(NSData *)key {
    return [self tt_hmacDataUsingAlg:kCCHmacAlgSHA512 withKey:key];
}
...
- (NSData *)tt_aes256EncryptWithKey:(NSData *)key iv:(NSData *)iv {
...
- (NSData *)tt_aes256DecryptWithkey:(NSData *)key iv:(NSData *)iv {
    if (key.length != 16 && key.length != 24 && key.length != 32) {
        return nil;
    }
    if (iv.length != 16 && iv.length != 0) {
...
+ (NSData *)tt_dataWithHexString:(NSString *)hexStr {
...
- (NSString *)tt_base64EncodedString {
    NSUInteger length = self.length;
    if (length == 0)
        return @"";
...
+ (NSData *)tt_dataWithBase64EncodedString:(NSString *)base64EncodedString {
...
+ (NSData *)tt_dataNamed:(NSString *)name {
