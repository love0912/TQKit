...
@implementation UITextView (TTExt)
...
- (void)setTt_placeholderColor:(UIColor *)tt_placeholderColor {
    self.placeholderLabel.textColor = tt_placeholderColor;
}

- (NSString *)tt_placeholder {
    return self.placeholderLabel.text;
}

- (void)setTt_placeholder:(NSString *)tt_placeholder {
    self.placeholderLabel.text = tt_placeholder;
    [self updatePlaceholderLabel];
}

- (NSAttributedString *)tt_attributedPlaceholder {
    return self.placeholderLabel.attributedText;
}

- (void)setTt_attributedPlaceholder:(NSAttributedString *)tt_attributedPlaceholder {
    self.placeholderLabel.attributedText = tt_attributedPlaceholder;
    [self updatePlaceholderLabel];
}
...
- (UILabel *)placeholderLabel {
    ...
    if (!label) {
        ...
        label.textColor = [self.class tt_defaultPlaceholderColor];
