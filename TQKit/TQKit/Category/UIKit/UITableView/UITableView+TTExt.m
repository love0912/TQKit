...
@implementation UITableView (TTExt)
 ...
 */
- (void)tt_updateWithBlock:(void (^)(UITableView *tableView))block {
    [self beginUpdates];
    block(self);
    [self endUpdates];
}
 ...
 */
- (void)tt_scrollToRow:(NSUInteger)row inSection:(NSUInteger)section atScrollPosition:(UITableViewScrollPosition)scrollPosition animated:(BOOL)animated {
 ...
 */
- (void)tt_insertRow:(NSUInteger)row inSection:(NSUInteger)section withRowAnimation:(UITableViewRowAnimation)animation {
    NSIndexPath *toInsert = [NSIndexPath indexPathForRow:row inSection:section];
    [self tt_insertRowAtIndexPath:toInsert withRowAnimation:animation];
}
 ...
 */
- (void)tt_reloadRow:(NSUInteger)row inSection:(NSUInteger)section withRowAnimation:(UITableViewRowAnimation)animation {
    NSIndexPath *toReload = [NSIndexPath indexPathForRow:row inSection:section];
    [self tt_reloadRowAtIndexPath:toReload withRowAnimation:animation];
}
 ...
 */
- (void)tt_deleteRow:(NSUInteger)row inSection:(NSUInteger)section withRowAnimation:(UITableViewRowAnimation)animation {
    NSIndexPath *toDelete = [NSIndexPath indexPathForRow:row inSection:section];
    [self tt_deleteRowAtIndexPath:toDelete withRowAnimation:animation];
}
...
/**
 ...
 perform when inserting the cell or requests no animation.
 */
- (void)tt_insertRowAtIndexPath:(NSIndexPath *)indexPath withRowAnimation:(UITableViewRowAnimation)animation {
...
/**
 ...
 right and the new cells slide in from the right.
 */
- (void)tt_reloadRowAtIndexPath:(NSIndexPath *)indexPath withRowAnimation:(UITableViewRowAnimation)animation {
...
/**
 ...
 for example, fade out or slide out from the bottom.
 */
- (void)tt_deleteRowAtIndexPath:(NSIndexPath *)indexPath withRowAnimation:(UITableViewRowAnimation)animation {
 ...
 */
- (void)tt_insertSection:(NSUInteger)section withRowAnimation:(UITableViewRowAnimation)animation {
 ...
 */
- (void)tt_deleteSection:(NSUInteger)section withRowAnimation:(UITableViewRowAnimation)animation {
    NSIndexSet *sections = [NSIndexSet indexSetWithIndex:section];
 ...
 */
- (void)tt_reloadSection:(NSUInteger)section withRowAnimation:(UITableViewRowAnimation)animation {
 ...
 */
- (void)tt_clearSelectedRowsAnimated:(BOOL)animated {
