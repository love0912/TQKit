...
@interface TTQRCodeScan ()<AVCaptureMetadataOutputObjectsDelegate, UIAlertViewDelegate, CAAnimationDelegate>
{
    BOOL _isScaning;
}
...
- (void)showScanBox {
    TTScanBoxLine *line1 = [TTScanBoxLine createLine2Color:self.lineColor lineWidth:4 lineLength:20 cornerPoint:_scanFrame.origin cornerLocation:TTScanBoxLineLocationTopLeft];
    TTScanBoxLine *line2 = [TTScanBoxLine createLine2Color:self.lineColor lineWidth:2 lineLength:20 cornerPoint:CGPointMake(_scanFrame.origin.x + _scanFrame.size.width, _scanFrame.origin.y) cornerLocation:TTScanBoxLineLocationTopRight];
    TTScanBoxLine *line3 = [TTScanBoxLine createLine2Color:self.lineColor lineWidth:2 lineLength:20 cornerPoint:CGPointMake(_scanFrame.origin.x, _scanFrame.origin.y + _scanFrame.size.height) cornerLocation:TTScanBoxLineLocationBottomLeft];
    TTScanBoxLine *line4 = [TTScanBoxLine createLine2Color:self.lineColor lineWidth:2 lineLength:20 cornerPoint:CGPointMake(_scanFrame.origin.x + _scanFrame.size.width, _scanFrame.origin.y + _scanFrame.size.height) cornerLocation:TTScanBoxLineLocationBottomRight];
